// Code generated by the Encore v1.28.0 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-coop-manager-m6k2.encr.app`
}
...
/**
 * Client is an API client for the coop-manager-m6k2 Encore application. 
 */
export default class Client {
    public readonly core: core.ServiceClient
    public readonly shifts: shifts.ServiceClient
    ...
    constructor(target: string | BaseURL = "prod", options?: string | ClientOptions) {
        ...
        this.shifts = new shifts.ServiceClient(base)
...
export namespace core {
    ...
    export class ServiceClient {
        ...
        public async Ping(): Promise<PingResponse> {
            ...
            const resp = await this.baseClient.callAPI("POST", `/ping`)
...
export namespace shifts {
    ...
    export class ServiceClient {
        ...
        public async Assign(params: AssignRequest): Promise<AssignResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/shifts/assign`, JSON.stringify(params))
            return await resp.json() as AssignResponse
        }

        public async GetAll(params: GetShiftsRequest): Promise<GetShiftsResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/shifts`, JSON.stringify(params))
            return await resp.json() as GetShiftsResponse
        }
    }
}
...
export namespace users {
    ...
    export class ServiceClient {
        ...
        public async GetMyUser(): Promise<GetUserResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/users/me`)
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        this.headers = {
            ...
            "User-Agent":   "coop-manager-m6k2-Generated-TS-Client (Encore/v1.28.0)",
        }
