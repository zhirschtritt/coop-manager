...
var (
	shiftAssignmentAllColumns            = []string{"organization_id", "member_id", "shift_id", "created_by"}
	shiftAssignmentColumnsWithoutDefault = []string{"organization_id", "member_id", "shift_id", "created_by"}
	shiftAssignmentColumnsWithDefault    = []string{}
	shiftAssignmentPrimaryKeyColumns     = []string{"member_id", "shift_id", "organization_id"}
...
// OneP returns a single shiftAssignment record from the query, and panics on error.
func (q shiftAssignmentQuery) OneP(ctx context.Context, exec boil.ContextExecutor) *ShiftAssignment {
...
// AllP returns all ShiftAssignment records from the query, and panics on error.
func (q shiftAssignmentQuery) AllP(ctx context.Context, exec boil.ContextExecutor) ShiftAssignmentSlice {
...
// CountP returns the count of all ShiftAssignment records in the query, and panics on error.
func (q shiftAssignmentQuery) CountP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (q shiftAssignmentQuery) ExistsP(ctx context.Context, exec boil.ContextExecutor) bool {
...
// SetCreatedByCoopEventP of the shiftAssignment to the related item.
// Sets o.R.CreatedByCoopEvent to related.
// Adds o to related.R.CreatedByShiftAssignments.
// Panics on error.
func (o *ShiftAssignment) SetCreatedByCoopEventP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *CoopEvent) {
	if err := o.SetCreatedByCoopEvent(ctx, exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
func (o *ShiftAssignment) SetCreatedByCoopEvent(ctx context.Context, exec boil.ContextExecutor, insert bool, related *CoopEvent) error {
	...
	values := []interface{}{related.ID, o.MemberID, o.ShiftID, o.OrganizationID}
...
// SetMemberP of the shiftAssignment to the related item.
// Sets o.R.Member to related.
// Adds o to related.R.ShiftAssignments.
// Panics on error.
func (o *ShiftAssignment) SetMemberP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Member) {
	if err := o.SetMember(ctx, exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// SetOrganizationP of the shiftAssignment to the related item.
// Sets o.R.Organization to related.
// Adds o to related.R.ShiftAssignments.
// Panics on error.
func (o *ShiftAssignment) SetOrganizationP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Organization) {
...
// SetShiftP of the shiftAssignment to the related item.
// Sets o.R.Shift to related.
// Adds o to related.R.ShiftAssignments.
// Panics on error.
func (o *ShiftAssignment) SetShiftP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Shift) {
	if err := o.SetShift(ctx, exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// FindShiftAssignmentP retrieves a single record by ID with an executor, and panics on error.
func FindShiftAssignmentP(ctx context.Context, exec boil.ContextExecutor, memberID string, shiftID string, organizationID string, selectCols ...string) *ShiftAssignment {
	retobj, err := FindShiftAssignment(ctx, exec, memberID, shiftID, organizationID, selectCols...)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func FindShiftAssignment(ctx context.Context, exec boil.ContextExecutor, memberID string, shiftID string, organizationID string, selectCols ...string) (*ShiftAssignment, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"shift_assignments\" where \"member_id\"=$1 AND \"shift_id\"=$2 AND \"organization_id\"=$3", sel,
	)

	q := queries.Raw(query, memberID, shiftID, organizationID)
...
func (o *ShiftAssignment) InsertP(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) {
...
// UpdateP uses an executor to update the ShiftAssignment, and panics on error.
// See Update for more documentation.
func (o *ShiftAssignment) UpdateP(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) int64 {
...
func (q shiftAssignmentQuery) UpdateAllP(ctx context.Context, exec boil.ContextExecutor, cols M) int64 {
...
func (o ShiftAssignmentSlice) UpdateAllP(ctx context.Context, exec boil.ContextExecutor, cols M) int64 {
...
func (o *ShiftAssignment) UpsertP(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) {
...
// DeleteP deletes a single ShiftAssignment record with an executor.
// DeleteP will match against the primary key column to find the record to delete.
// Panics on error.
func (o *ShiftAssignment) DeleteP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (o *ShiftAssignment) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"shift_assignments\" WHERE \"member_id\"=$1 AND \"shift_id\"=$2 AND \"organization_id\"=$3"
...
func (q shiftAssignmentQuery) DeleteAllP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (o ShiftAssignmentSlice) DeleteAllP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (o *ShiftAssignment) ReloadP(ctx context.Context, exec boil.ContextExecutor) {
...
func (o *ShiftAssignment) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindShiftAssignment(ctx, exec, o.MemberID, o.ShiftID, o.OrganizationID)
	if err != nil {
		return err
	}
...
// Panics on error.
func (o *ShiftAssignmentSlice) ReloadAllP(ctx context.Context, exec boil.ContextExecutor) {
...
// ShiftAssignmentExistsP checks if the ShiftAssignment row exists. Panics on error.
func ShiftAssignmentExistsP(ctx context.Context, exec boil.ContextExecutor, memberID string, shiftID string, organizationID string) bool {
	e, err := ShiftAssignmentExists(ctx, exec, memberID, shiftID, organizationID)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func ShiftAssignmentExists(ctx context.Context, exec boil.ContextExecutor, memberID string, shiftID string, organizationID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"shift_assignments\" where \"member_id\"=$1 AND \"shift_id\"=$2 AND \"organization_id\"=$3 limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, memberID, shiftID, organizationID)
	}
	row := exec.QueryRowContext(ctx, sql, memberID, shiftID, organizationID)
...
func (o *ShiftAssignment) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return ShiftAssignmentExists(ctx, exec, o.MemberID, o.ShiftID, o.OrganizationID)
}
