...
var (
	...
	membershipPrimaryKeyColumns     = []string{"member_id", "organization_id", "membership_type_id"}
...
// OneP returns a single membership record from the query, and panics on error.
func (q membershipQuery) OneP(ctx context.Context, exec boil.ContextExecutor) *Membership {
...
// AllP returns all Membership records from the query, and panics on error.
func (q membershipQuery) AllP(ctx context.Context, exec boil.ContextExecutor) MembershipSlice {
...
// CountP returns the count of all Membership records in the query, and panics on error.
func (q membershipQuery) CountP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (q membershipQuery) ExistsP(ctx context.Context, exec boil.ContextExecutor) bool {
...
// SetCreatedByCoopEventP of the membership to the related item.
// Sets o.R.CreatedByCoopEvent to related.
// Adds o to related.R.CreatedByMemberships.
// Panics on error.
func (o *Membership) SetCreatedByCoopEventP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *CoopEvent) {
...
func (o *Membership) SetCreatedByCoopEvent(ctx context.Context, exec boil.ContextExecutor, insert bool, related *CoopEvent) error {
	...
	values := []interface{}{related.ID, o.MemberID, o.OrganizationID, o.MembershipTypeID}
...
// SetMemberP of the membership to the related item.
// Sets o.R.Member to related.
// Adds o to related.R.Memberships.
// Panics on error.
func (o *Membership) SetMemberP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Member) {
...
// SetMembershipTypeP of the membership to the related item.
// Sets o.R.MembershipType to related.
// Adds o to related.R.Memberships.
// Panics on error.
func (o *Membership) SetMembershipTypeP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *MembershipType) {
	if err := o.SetMembershipType(ctx, exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// SetOrganizationP of the membership to the related item.
// Sets o.R.Organization to related.
// Adds o to related.R.Memberships.
// Panics on error.
func (o *Membership) SetOrganizationP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Organization) {
...
// FindMembershipP retrieves a single record by ID with an executor, and panics on error.
func FindMembershipP(ctx context.Context, exec boil.ContextExecutor, memberID string, organizationID string, membershipTypeID string, selectCols ...string) *Membership {
	retobj, err := FindMembership(ctx, exec, memberID, organizationID, membershipTypeID, selectCols...)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func FindMembership(ctx context.Context, exec boil.ContextExecutor, memberID string, organizationID string, membershipTypeID string, selectCols ...string) (*Membership, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"memberships\" where \"member_id\"=$1 AND \"organization_id\"=$2 AND \"membership_type_id\"=$3", sel,
	)

	q := queries.Raw(query, memberID, organizationID, membershipTypeID)
...
func (o *Membership) InsertP(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) {
...
// UpdateP uses an executor to update the Membership, and panics on error.
// See Update for more documentation.
func (o *Membership) UpdateP(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) int64 {
...
func (q membershipQuery) UpdateAllP(ctx context.Context, exec boil.ContextExecutor, cols M) int64 {
...
func (o MembershipSlice) UpdateAllP(ctx context.Context, exec boil.ContextExecutor, cols M) int64 {
...
func (o *Membership) UpsertP(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) {
...
// DeleteP deletes a single Membership record with an executor.
// DeleteP will match against the primary key column to find the record to delete.
// Panics on error.
func (o *Membership) DeleteP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (o *Membership) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"memberships\" WHERE \"member_id\"=$1 AND \"organization_id\"=$2 AND \"membership_type_id\"=$3"
...
func (q membershipQuery) DeleteAllP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (o MembershipSlice) DeleteAllP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (o *Membership) ReloadP(ctx context.Context, exec boil.ContextExecutor) {
...
func (o *Membership) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindMembership(ctx, exec, o.MemberID, o.OrganizationID, o.MembershipTypeID)
	if err != nil {
		return err
	}
...
// Panics on error.
func (o *MembershipSlice) ReloadAllP(ctx context.Context, exec boil.ContextExecutor) {
...
// MembershipExistsP checks if the Membership row exists. Panics on error.
func MembershipExistsP(ctx context.Context, exec boil.ContextExecutor, memberID string, organizationID string, membershipTypeID string) bool {
	e, err := MembershipExists(ctx, exec, memberID, organizationID, membershipTypeID)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func MembershipExists(ctx context.Context, exec boil.ContextExecutor, memberID string, organizationID string, membershipTypeID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"memberships\" where \"member_id\"=$1 AND \"organization_id\"=$2 AND \"membership_type_id\"=$3 limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, memberID, organizationID, membershipTypeID)
	}
	row := exec.QueryRowContext(ctx, sql, memberID, organizationID, membershipTypeID)
...
func (o *Membership) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return MembershipExists(ctx, exec, o.MemberID, o.OrganizationID, o.MembershipTypeID)
}
