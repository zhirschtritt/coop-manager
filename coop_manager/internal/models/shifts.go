...
func (r *shiftR) GetShiftSlots() ShiftSlotSlice {
	if r == nil {
		return nil
	}
	return r.ShiftSlots
...
var (
	shiftAllColumns            = []string{"id", "organization_id", "start_at", "end_at", "shift_term_id"}
	shiftColumnsWithoutDefault = []string{"organization_id", "start_at", "end_at"}
	shiftColumnsWithDefault    = []string{"id", "shift_term_id"}
...
// OneG returns a single shift record from the query using the global executor.
func (q shiftQuery) OneG(ctx context.Context) (*Shift, error) {
...
// AllG returns all Shift records from the query using the global executor.
func (q shiftQuery) AllG(ctx context.Context) (ShiftSlice, error) {
...
// CountG returns the count of all Shift records in the query using the global executor
func (q shiftQuery) CountG(ctx context.Context) (int64, error) {
...
func (q shiftQuery) ExistsG(ctx context.Context) (bool, error) {
...
func (o *Shift) ShiftSlots(mods ...qm.QueryMod) shiftSlotQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"shift_slots\".\"shift_id\"=?", o.ID),
	)
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (shiftL) LoadShiftSlots(ctx context.Context, e boil.ContextExecutor, singular bool, maybeShift interface{}, mods queries.Applicator) error {
	var slice []*Shift
	var object *Shift
	...
	query := NewQuery(
		qm.From(`shift_slots`),
		qm.WhereIn(`shift_slots.shift_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetOrganizationG of the shift to the related item.
// Sets o.R.Organization to related.
// Adds o to related.R.Shifts.
// Uses the global database handle.
func (o *Shift) SetOrganizationG(ctx context.Context, insert bool, related *Organization) error {
...
// SetShiftTermG of the shift to the related item.
// Sets o.R.ShiftTerm to related.
// Adds o to related.R.Shifts.
// Uses the global database handle.
func (o *Shift) SetShiftTermG(ctx context.Context, insert bool, related *ShiftTerm) error {
	return o.SetShiftTerm(ctx, boil.GetContextDB(), insert, related)
}
...
// RemoveShiftTermG relationship.
// Sets o.R.ShiftTerm to nil.
// Removes o from all passed in related items' relationships struct.
// Uses the global database handle.
func (o *Shift) RemoveShiftTermG(ctx context.Context, related *ShiftTerm) error {
	return o.RemoveShiftTerm(ctx, boil.GetContextDB(), related)
}
...
// Uses the global database handle.
func (o *Shift) AddShiftAssignmentsG(ctx context.Context, insert bool, related ...*ShiftAssignment) error {
...
// Sets related.R.Shift appropriately.
// Uses the global database handle.
func (o *Shift) AddShiftSlotsG(ctx context.Context, insert bool, related ...*ShiftSlot) error {
...
// Appends related to o.R.ShiftSlots.
// Sets related.R.Shift appropriately.
func (o *Shift) AddShiftSlots(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ShiftSlot) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.ShiftID = o.ID
...
// FindShiftG retrieves a single record by ID.
func FindShiftG(ctx context.Context, iD string, selectCols ...string) (*Shift, error) {
	return FindShift(ctx, boil.GetContextDB(), iD, selectCols...)
}
...
func (o *Shift) InsertG(ctx context.Context, columns boil.Columns) error {
...
// UpdateG a single Shift record using the global executor.
// See Update for more documentation.
func (o *Shift) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
...
func (q shiftQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
// UpdateAllG updates all rows with the specified column values.
func (o ShiftSlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o *Shift) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
...
// DeleteG deletes a single Shift record.
// DeleteG will match against the primary key column to find the record to delete.
func (o *Shift) DeleteG(ctx context.Context) (int64, error) {
...
func (q shiftQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o ShiftSlice) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o *Shift) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: no Shift provided for reload")
	}
...
func (o *ShiftSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: empty ShiftSlice provided for reload all")
	}
...
// ShiftExistsG checks if the Shift row exists.
func ShiftExistsG(ctx context.Context, iD string) (bool, error) {
	return ShiftExists(ctx, boil.GetContextDB(), iD)
}
