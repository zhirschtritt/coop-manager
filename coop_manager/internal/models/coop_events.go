...
// OneG returns a single coopEvent record from the query using the global executor.
func (q coopEventQuery) OneG(ctx context.Context) (*CoopEvent, error) {
...
// AllG returns all CoopEvent records from the query using the global executor.
func (q coopEventQuery) AllG(ctx context.Context) (CoopEventSlice, error) {
...
// CountG returns the count of all CoopEvent records in the query using the global executor
func (q coopEventQuery) CountG(ctx context.Context) (int64, error) {
...
func (q coopEventQuery) ExistsG(ctx context.Context) (bool, error) {
...
func (o *CoopEvent) AddCreatedByShiftAssignmentsG(ctx context.Context, insert bool, related ...*ShiftAssignment) error {
	return o.AddCreatedByShiftAssignments(ctx, boil.GetContextDB(), insert, related...)
}
...
// FindCoopEventG retrieves a single record by ID.
func FindCoopEventG(ctx context.Context, iD string, selectCols ...string) (*CoopEvent, error) {
	return FindCoopEvent(ctx, boil.GetContextDB(), iD, selectCols...)
}
...
func (o *CoopEvent) InsertG(ctx context.Context, columns boil.Columns) error {
...
// UpdateG a single CoopEvent record using the global executor.
// See Update for more documentation.
func (o *CoopEvent) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
...
func (q coopEventQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
// UpdateAllG updates all rows with the specified column values.
func (o CoopEventSlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o *CoopEvent) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
...
// DeleteG deletes a single CoopEvent record.
// DeleteG will match against the primary key column to find the record to delete.
func (o *CoopEvent) DeleteG(ctx context.Context) (int64, error) {
...
func (q coopEventQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o CoopEventSlice) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o *CoopEvent) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: no CoopEvent provided for reload")
	}
...
func (o *CoopEventSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: empty CoopEventSlice provided for reload all")
	}
...
// CoopEventExistsG checks if the CoopEvent row exists.
func CoopEventExistsG(ctx context.Context, iD string) (bool, error) {
	return CoopEventExists(ctx, boil.GetContextDB(), iD)
}
